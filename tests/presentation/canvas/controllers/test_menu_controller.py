...
class TestMenuControllerInitialization:
    ...
    def test_initialize_sets_flag(self, mock_main_window):
...
class TestRecentFilesMenu:
    ...
    @patch("casare_rpa.canvas.workflow.recent_files.get_recent_files_manager")
    def test_get_recent_files(self, mock_manager_func, menu_controller):
...
class TestAboutDialog:
    ...
    def test_show_about_dialog(self, menu_controller, mock_main_window):
...
class TestDesktopSelectorBuilder:
    ...
    def test_show_desktop_selector_builder(self, menu_controller, mock_main_window):
...
class TestHelpMenuOperations:
    ...
    def test_show_documentation(self, menu_controller, mock_main_window):
    ...
    def test_show_documentation_local_docs(self, menu_controller, mock_main_window):
    ...
    def test_show_keyboard_shortcuts(self, menu_controller, mock_main_window):
    ...
    def test_check_for_updates(self, menu_controller, mock_main_window):
...
class TestHotkeyManagement:
    ...
    def test_open_hotkey_manager(self, menu_controller, mock_main_window):
    ...
    def test_open_hotkey_manager_saves_changes(self, menu_controller, mock_main_window):
...
class TestPreferences:
    ...
    def test_open_preferences(self, menu_controller, mock_main_window):
    ...
    def test_open_preferences_saves(self, menu_controller, mock_main_window):
...
class TestPrivateMethods:
    ...
    def test_reload_hotkeys(self, menu_controller):
...
class TestSignals:
    ...
    def test_about_dialog_shown_signal(self, menu_controller):
    ...
    def test_desktop_selector_shown_signal(self, menu_controller, mock_main_window):
