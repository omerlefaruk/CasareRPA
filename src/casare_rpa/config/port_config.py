...
=======
            ...
            redis=_parse_int(os.getenv("CASARE_PORT_REDIS") or os.getenv("REDIS_PORT"), 6379),
            metrics=_parse_int(os.getenv("CASARE_PORT_METRICS") or os.getenv("METRICS_PORT"), 9090),
            websocket=_parse_int(os.getenv("CASARE_PORT_WEBSOCKET") or os.getenv("WS_PORT"), 8001),
        )
