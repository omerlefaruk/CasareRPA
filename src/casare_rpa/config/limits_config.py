...
<<<<<<< HEAD
            ...
            workflow_max_depth=_parse_int(
                os.getenv("CASARE_LIMIT_WORKFLOW_MAX_DEPTH"), 10
            ),
            # Content limits
            html_max_length=_parse_int(
                os.getenv("CASARE_LIMIT_HTML_MAX_LENGTH"), 50000
            ),
            log_line_max_length=_parse_int(
                os.getenv("CASARE_LIMIT_LOG_LINE_MAX_LENGTH"), 10000
            ),
            # LLM limits
            llm_max_tokens=_parse_int(os.getenv("CASARE_LIMIT_LLM_MAX_TOKENS"), 1000),
            llm_context_chars=_parse_int(
                os.getenv("CASARE_LIMIT_LLM_CONTEXT_CHARS"), 3000
            ),
