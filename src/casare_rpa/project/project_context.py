...
class ProjectContext:
    """
    Runtime context for project-scoped resources.

    Provides access to project and global variables/credentials
    during workflow execution. Used by ExecutionContext for
    variable resolution.
    ...
    @classmethod
    def from_project(cls, project: Project) -> "ProjectContext":
        """
