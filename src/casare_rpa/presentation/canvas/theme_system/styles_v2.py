...
Usage:
    from casare_rpa.presentation.canvas.theme_system import get_canvas_stylesheet_v2
...
QMenuBar {{
    ...
    padding: {TOKENS_V2.spacing.xs}px {TOKENS_V2.spacing.xxs}px;
}}
...
QMenu::item {{
    background-color: transparent;
    padding: {TOKENS_V2.spacing.xxs}px {TOKENS_V2.spacing.md}px {TOKENS_V2.spacing.xxs}px {TOKENS_V2.spacing.xs}px;
    border-radius: {TOKENS_V2.radius.xs}px;
    height: {TOKENS_V2.sizes.menu_item_height}px;
    color: {THEME_V2.text_primary};
...
QTableView, QTableWidget, QTreeView, QTreeWidget, QListView, QListWidget {{
    background-color: {THEME_V2.bg_surface};
    alternate-background-color: {THEME_V2.bg_canvas};
    border: none;
