...
from casare_rpa.utils.fuzzy_search import fuzzy_search, highlight_matches
...
class SearchableNodeMenu(QMenu):
    ...
    def setup_search(self):
        ...
        self._search_input.setPlaceholderText(
            "Search nodes... (e.g., 'b l' for Browser Launch)"
        )
    ...
    def add_node_item(
        self, category: str, name: str, description: str, callback: Callable
    ):
        """
    ...
    def build_menu(self):
        ...
        for category in sorted(categories.keys()):
            ...
            for name, description, callback in sorted(
                    ...
                    if sub_action.isVisible():
                        ...
                        if data and auto_connect:
                            ...
                            self.node_creation_requested.emit(
                                data.get("category", ""), data.get("name", ""), True
                            )
