...
DATA_OUTPUT_NODES = {
    ...
    "CloseBrowserNode": [],
    "TooltipNode": [],
    "RunPythonScriptNode": ["result", "output", "error", "success"],
    "RunJavaScriptNode": ["result", "output", "error", "success"],
...
DATA_INPUT_NODES = {
    ...
    "RunPythonScriptNode": ["code", "variables"],
    "RunJavaScriptNode": ["code", "variables"],
    "StructuredDataSuperNode": [
        "file_path",
        "data",
        "headers",
