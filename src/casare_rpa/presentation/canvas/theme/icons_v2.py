...
# =============================================================================
# QT APPLICATION SAFETY
# =============================================================================


def _ensure_qapplication() -> None:
    """
    Ensure a Qt application exists before creating QPixmap/QIcon resources.

    Qt may hard-crash on some platforms if QPixmap/QSvgRenderer are used before a
    QApplication/QGuiApplication is constructed.
    """
...
class IconProviderV2:
    ...
    @classmethod
    def _render_svg(cls, svg_content: str, size: int, color: str) -> QPixmap:
        """
    ...
    @classmethod
    def get_icon(cls, name: str, size: IconSize = 20, state: IconState = "normal") -> QIcon:
        """
    ...
    @classmethod
    def get_pixmap(
        cls, name: str, size: IconSize = 20, state: IconState = "normal"
    ) -> QPixmap | None:
        """
    ...
    def get_available_icons(cls) -> list[str]:
        ...
        return [f.stem for f in icons_dir.glob("*.svg") if f.is_file()]
