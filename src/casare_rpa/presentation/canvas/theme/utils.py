"""
Theme utilities for CasareRPA Canvas.
...
def _hex_to_qcolor(hex_color: str):
    ...
    Kept as a compatibility helper for presentation-layer rendering code that
    needs QColor instances (graph items, painters, etc.).
    """
    from PySide6.QtGui import QColor

    return QColor(normalize_hex(hex_color))
