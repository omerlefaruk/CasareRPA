...
def _remove_existing_property(node: VisualNode, prop_name: str) -> None:
    ...
    or text inputs that may already exist from @properties decoration.
...
class VisualCloseApplicationNode(VisualNode):
    ...
    Widgets are auto-generated from the @properties on CloseApplicationNode.
    ...
    def __init__(self) -> None:
        ...
        # force_close and timeout are auto-generated from @properties
...
class VisualYOLOFindElementNode(VisualNode):
    """Visual representation of YOLOFindElementNode."""

    CASARE_NODE_CLASS = "YOLOFindElementNode"
    ...
    def __init__(self) -> None:
        """Initialize YOLO Find Element node."""
        super().__init__()
        # Widgets auto-generated by @properties decorator
    ...
    def setup_ports(self) -> None:
        """Setup ports."""
        self.add_exec_input()
        self.add_typed_input("window_handle", DataType.INTEGER)
        self.add_exec_output()
        ...
        self.add_typed_output("found", DataType.BOOLEAN)
        self.add_typed_output("all_elements", DataType.LIST)
...
class VisualSendKeysNode(VisualNode):
    ...
    Widgets are auto-generated from the @properties on SendKeysNode.
...
class VisualSendHotKeyNode(VisualNode):
    ...
    Widgets are auto-generated from the @properties on SendHotKeyNode:
