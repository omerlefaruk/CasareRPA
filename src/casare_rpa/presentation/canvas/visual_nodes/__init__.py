...
_VISUAL_NODE_REGISTRY: Dict[str, str] = {
    ...
    "VisualTelegramEditMessageNode": "messaging.nodes",
    "VisualTelegramDeleteMessageNode": "messaging.nodes",
    "VisualTelegramSendMediaGroupNode": "messaging.nodes",
    "VisualTelegramAnswerCallbackNode": "messaging.nodes",
    "VisualTelegramGetUpdatesNode": "messaging.nodes",
    # Messaging - WhatsApp (7 nodes)
    "VisualWhatsAppSendMessageNode": "messaging.nodes",
    "VisualWhatsAppSendTemplateNode": "messaging.nodes",
    "VisualWhatsAppSendImageNode": "messaging.nodes",
    "VisualWhatsAppSendDocumentNode": "messaging.nodes",
    "VisualWhatsAppSendVideoNode": "messaging.nodes",
    "VisualWhatsAppSendLocationNode": "messaging.nodes",
    "VisualWhatsAppSendInteractiveNode": "messaging.nodes",
    ...
    "VisualDriveRemovePermissionNode": "google",
