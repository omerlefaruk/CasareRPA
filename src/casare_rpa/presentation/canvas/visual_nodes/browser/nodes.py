...
# Alert and Cookie Management Nodes


class VisualBrowserAlertHandleNode(VisualNode):
    """
    Visual representation of BrowserAlertHandleNode.

    Handles JavaScript dialogs (alerts, confirms, prompts).
    """

    __identifier__ = "casare_rpa.browser"
    NODE_NAME = "Handle Alert"
    NODE_CATEGORY = "browser/interaction"
    CASARE_NODE_CLASS = "BrowserAlertHandleNode"

    def __init__(self) -> None:
        """Initialize alert handle node."""
        super().__init__()
        # Widgets auto-generated by @properties decorator
    ...
    def setup_ports(self) -> None:
        """Setup ports."""
        self.add_exec_input("exec_in")
        self.add_typed_input("trigger_selector", DataType.STRING, required=False)
        self.add_typed_input("page", DataType.PAGE, required=False)
        self.add_exec_output("exec_out")
        self.add_typed_output("page", DataType.PAGE)
        self.add_typed_output("message", DataType.STRING)
        self.add_typed_output("dialog_type", DataType.STRING)
        self.add_typed_output("action_taken", DataType.STRING)
        self.add_typed_output("success", DataType.BOOLEAN)


class VisualCookieManagementNode(VisualNode):
    """
    Visual representation of CookieManagementNode.

    Manages browser cookies (get, set, delete, export, import).
    """

    __identifier__ = "casare_rpa.browser"
    NODE_NAME = "Cookie Management"
    NODE_CATEGORY = "browser/data"
    CASARE_NODE_CLASS = "CookieManagementNode"

    def __init__(self) -> None:
        """Initialize cookie management node."""
        super().__init__()
        # Widgets auto-generated by @properties decorator
    ...
    def setup_ports(self) -> None:
        """Setup ports."""
        self.add_exec_input("exec_in")
        self.add_typed_input("cookies_input", DataType.STRING, required=False)
        self.add_typed_input("page", DataType.PAGE, required=False)
        self.add_exec_output("exec_out")
        self.add_typed_output("page", DataType.PAGE)
        self.add_typed_output("cookies", DataType.STRING)
        self.add_typed_output("cookie", DataType.DICT)
        self.add_typed_output("count", DataType.INTEGER)
        self.add_typed_output("success", DataType.BOOLEAN)
