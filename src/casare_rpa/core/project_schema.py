"""
CasareRPA - Project Schema
Defines the data models for projects, scenarios, variables, and credential bindings.
"""
...
class ProjectVariable:
    ...
    Extends the basic variable concept with sensitivity and read-only flags.
...
class CredentialBinding:
    ...
    Allows projects/scenarios to reference credentials by friendly names
    that can be remapped to different Vault paths per environment.
...
class Project:
    """
    Represents a CasareRPA project.
    ...
    @classmethod
    def create_new(cls, name: str, path: Path, **kwargs) -> "Project":
...
class Scenario:
    """
    Represents a scenario: a workflow + data bundle.
