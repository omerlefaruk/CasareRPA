...
from casare_rpa.utils.template_loader import TemplateInfo, get_template_loader
...
class TemplateBrowserDialog(QDialog):
    ...
    def _on_template_selected(self):
        ...
        self.category_label.setText(f"<b>Category:</b> {template.category.replace('_', ' ').title()}")
        self.tags_label.setText(f"<b>Tags:</b> {', '.join(template.tags) if template.tags else 'None'}")
