...
NODE_REGISTRY: dict[str, str | tuple[str, str]] = {
    ...
    "BrowserRunScriptNode": "browser.scripting",
    "RerouteNode": "utility_nodes",
    "OCRNode": ("desktop_nodes.screenshot_ocr_nodes", "OCRExtractTextNode"),
    "YOLOFindElementNode": "desktop_nodes.yolo_find_node",
    "AIRecoveryNode": "error_handling",
    ...
    "FuzzyStringMatchNode": "string_nodes",
    "FilterBySimilarityNode": "string_nodes",
    ...
    # Super Nodes
    "ListSuperNode": "data.list_super_node",
    "DictSuperNode": "data.dict_super_node",
    ...
    "BaseTriggerNode": "trigger_nodes.base_trigger_node",
    "DetectFormsNode": "browser.detect_forms_node",
    # Google Base Classes
    "GoogleBaseNode": "google.google_base",
    "DriveBaseNode": "google.google_base",
    "GmailBaseNode": "google.google_base",
    "SheetsBaseNode": "google.google_base",
    "DocsBaseNode": "google.google_base",
    "CalendarBaseNode": "google.google_base",
    # Browser Base Classes
    "BrowserBaseNode": "browser.browser_base",
    "HttpBaseNode": "http.http_base",
    "LLMBaseNode": "llm.llm_base",
    "TelegramBaseNode": "messaging.telegram",
    "WhatsAppBaseNode": "messaging.whatsapp.whatsapp_base",
    # OAuth nodes
    "OAuth2AuthorizeNode": "http.http_auth",
    "OAuth2CallbackServerNode": "http.http_auth",
    "OAuth2TokenExchangeNode": "http.http_auth",
    "OAuth2TokenValidateNode": "http.http_auth",
    "DriveCreateShareLinkNode": "google.drive_nodes",
    "DriveRemoveShareNode": "google.drive_nodes",
    "GmailSendDraftNode": "google.gmail_nodes",
    "SheetsCopySheetNode": "google.sheets",
    "SheetsGetColumnNode": "google.sheets",
    "SheetsGetRowNode": "google.sheets",
    "SheetsGetSheetInfoNode": "google.sheets",
    "SheetsSearchNode": "google.sheets",
    "SheetsUpdateRowNode": "google.sheets",
    "SheetsWriteCellNode": "google.sheets",
    "DocumentBaseNode": "document.document_nodes",
    ...
    # Sheets nodes (google.sheets + legacy sheets_nodes)
    "SheetsGetCellNode": "google.sheets",
    "SheetsSetCellNode": "google.sheets_nodes",
    "SheetsGetRangeNode": "google.sheets",
    "SheetsWriteRangeNode": "google.sheets",
    "SheetsClearRangeNode": "google.sheets",
    "SheetsCreateSpreadsheetNode": "google.sheets",
    "SheetsGetSpreadsheetNode": "google.sheets",
    "SheetsAddSheetNode": "google.sheets",
    "SheetsDeleteSheetNode": "google.sheets",
    "SheetsDuplicateSheetNode": "google.sheets",
    "SheetsRenameSheetNode": "google.sheets",
    "SheetsAppendRowNode": "google.sheets",
    "SheetsInsertRowNode": "google.sheets",
    "SheetsDeleteRowNode": "google.sheets",
    ...
    "SheetsBatchUpdateNode": "google.sheets",
    "SheetsBatchGetNode": "google.sheets",
    "SheetsBatchClearNode": "google.sheets",
