...
_NODE_REGISTRY: Dict[str, str] = {
    ...
    "ListFilesNode": "file_nodes",
    "FileExistsNode": "file_nodes",
    "GetFileSizeNode": "file_nodes",
    ...
    # HTTP/REST API nodes
    "HttpGetNode": "http_nodes",
    "HttpPostNode": "http_nodes",
    "HttpPutNode": "http_nodes",
    "HttpPatchNode": "http_nodes",
    "HttpDeleteNode": "http_nodes",
    "SetHttpHeadersNode": "http_nodes",
    "HttpAuthNode": "http_nodes",
    "ParseJsonResponseNode": "http_nodes",
