"""
Properties Panel for CasareRPA.

Dockable panel that displays and edits properties of the selected node.
Similar to the properties panel in UiPath, n8n, and VS Code.
"""
...
class PropertiesPanel(QDockWidget):
    ...
    Shows node information and editable properties when a node is selected.
    """

    property_changed = Signal(str, str, object)  # node_id, property_name, value
