...
Execute automatic agent chaining with error recovery loops. Reference: `.claude/rules/01-workflow-default.md` and `.claude/rules/02-architecture.md`
...
!Task(subagent_type="explore", prompt="Find relevant rules and documentation for: $ARGUMENTS.description. Search .claude/rules/, .brain/, and docs/. Return: relevant rules, patterns to follow, gotchas.")
```
...
Follow patterns from explore findings and .claude/rules/02-architecture.md")
```
