...
- **Quality Fixes 2025**: Ongoing maintenance to resolve pre-commit hook violations including node registry sync, theme colors, signal/slot best practices, **restored/modernized Profiler panel**, and **tab navigation type hint fixes**.
